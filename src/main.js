...
let md5Work = "b14d1e9baeced9bb7525ab19ee35f2d2"; //md5FL MD5 加密开启vconsole模式
// let md5UnWork = "3dca2162c4e101b7656793a1af20295c"; //md5UnWork MD5 加密关闭vconsole模式
...
if (vconsole !== undefined) {
  if (vconsole === md5Work && cookie.has(cookieName)) cookie.remove(cookieName);
} else vconsole = cookie.get(cookieName);

if (vconsole !== undefined && vconsole === md5Work) {
  cookie.set(cookieName, md5Work, 3600);
